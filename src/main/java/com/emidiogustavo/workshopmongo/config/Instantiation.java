...
import com.emidiogustavo.workshopmongo.DTO.AuthorDTO;
import com.emidiogustavo.workshopmongo.DTO.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {	
		...
		CommentDTO c1 = new CommentDTO("Boa viagem ano",sdf.parse("21/03/2018"), new AuthorDTO(alex));
